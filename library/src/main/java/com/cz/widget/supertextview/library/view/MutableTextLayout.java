...
import com.cz.widget.supertextview.library.text.change.SpanWatcher;
import com.cz.widget.supertextview.library.text.change.TextWatcher;
 ...
 */
public class MutableTextLayout extends ViewGroup implements TextParent{
    ...
    public MutableTextLayout(Context context) {
        this(context,null,0);
    }

    public MutableTextLayout(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MutableTextLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MutableTextLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//                    invalidate();
        ...
        public void run() {
            if(!scroller.isFinished()&&scroller.computeScrollOffset()){
                ...
                if(!layout.canVerticalScroll()){
                    ...
                    invalidate();
                    //持续发送事件
                    postOnAnimation(MutableTextLayout.this, this);
                }
            }
        }
    ...
    private class ChangeWatcher implements TextWatcher, SpanWatcher {
        ...
        public void beforeTextChanged(CharSequence buffer, int start,
                                      int before, int after) {
            sendBeforeTextChanged(buffer, start, before, after);
        }
        ...
        public void afterTextChanged(Editable buffer) {
            sendAfterTextChanged(buffer);
        }

        public void onSpanChanged(Spannable buf,
                                  Object what, int s, int e, int st, int en) {
            spanChange(buf, what, s, st, e, en);
        }

        public void onSpanAdded(Spannable buf, Object what, int s, int e) {
            spanChange(buf, what, -1, s, -1, e);
        }

        public void onSpanRemoved(Spannable buf, Object what, int s, int e) {
            spanChange(buf, what, s, -1, e, -1);
        }
    }
