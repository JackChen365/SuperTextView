...
package com.cz.widget.supertextview.library.spannable;
    ...
    /* package */ void setSpan(Object what, int start, int end, int flags) {
        ...
        if ((flags & Spannable.SPAN_PARAGRAPH) == Spannable.SPAN_PARAGRAPH) {
            if (start != 0 && start != length()) {
                ...
                if (c != '\n')
                    throw new RuntimeException(
                            "PARAGRAPH span must lineStart at paragraph boundary" +
                            " (" + start + " follows " + c + ")");
            }
            ...
            if (end != 0 && end != length()) {
                ...
                if (c != '\n')
                    throw new RuntimeException(
                            "PARAGRAPH span must lineEnd at paragraph boundary" +
                            " (" + end + " follows " + c + ")");
            }
        }
