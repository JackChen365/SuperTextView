...
class TextLayoutSample1Activity : ToolBarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageLayout1 = layoutInflater.inflate(R.layout.image_layout1, text1, false)
        spanList.put("VewSpan 添加View体1", ViewSpan(imageLayout1))
        val imageLayout2 = layoutInflater.inflate(R.layout.progress_layout1, text1, false)
